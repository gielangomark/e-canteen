...
<x-slot name="header">
    ...
    <div class="rounded-2xl p-5 mb-6" style="background: rgba(30,27,75,0.5); border: 1px solid rgba(99,102,241,0.12);">
        <form method="GET" action="{{ route('admin.reports.index') }}" class="flex items-end gap-4">
            ...
            <button type="submit" class="px-5 py-2.5 gradient-primary text-white text-sm font-semibold rounded-xl shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 transition-all">
                Lihat Laporan
            </button>
        </form>
    </div>
                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr style="border-bottom: 1px solid rgba(99,102,241,0.1);">
                                ...
                                <th class="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wider">Nama Menu</th>
                                <th class="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wider">Kategori</th>
                                <th class="px-4 py-3 text-right text-xs font-semibold text-slate-400 uppercase tracking-wider">Porsi Terjual</th>
                                <th class="px-4 py-3 text-right text-xs font-semibold text-slate-400 uppercase tracking-wider">Pendapatan</th>
                            </tr>
                        </thead>
