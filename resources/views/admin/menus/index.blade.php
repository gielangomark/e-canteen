...
<x-slot name="header">
    ...
    @if(!$menus->isEmpty())
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="rounded-2xl p-4 flex items-center gap-3" style="background: rgba(30,27,75,0.5); border: 1px solid rgba(99,102,241,0.12);">
                <div class="w-11 h-11 bg-orange-500/10 rounded-xl flex items-center justify-center">
                    <span class="text-lg">🍚</span>
                </div>
                <div>
            ...
            <div class="rounded-2xl p-4 flex items-center gap-3" style="background: rgba(30,27,75,0.5); border: 1px solid rgba(99,102,241,0.12);">
                <div class="w-11 h-11 bg-purple-500/10 rounded-xl flex items-center justify-center">
                    <span class="text-lg">🍿</span>
                </div>
                <div>
    ...
    @if($menus->isEmpty())
        <div class="rounded-2xl p-16 text-center" style="background: rgba(30,27,75,0.5); border: 1px solid rgba(99,102,241,0.12);">
            ...
            <p class="text-sm text-slate-500 mt-1 mb-6">Mulai tambahkan menu kantin pertama Anda!</p>
            <a href="{{ route('admin.menus.create') }}" class="inline-flex items-center gap-2 px-6 py-3 gradient-primary text-white font-semibold rounded-xl shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 transition-all">
    ...
    @else
        ...
        <div class="mb-5 flex justify-end">
            <a href="{{ route('admin.menus.create') }}" class="inline-flex items-center gap-2 px-5 py-2.5 gradient-primary text-white text-sm font-semibold rounded-xl shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 hover:-translate-y-0.5 transition-all">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/></svg>
                Tambah Menu
            </a>
        </div>
                ...
                <div class="group rounded-2xl overflow-hidden hover:shadow-xl hover:shadow-indigo-500/10 hover:-translate-y-1 transition-all duration-300" style="background: rgba(30,27,75,0.5); border: 1px solid rgba(99,102,241,0.12);">
                    ...
                    <div class="relative h-44 overflow-hidden">
                        ...
                        @else
                            ...
                            ">
                                ...
                                <div class="absolute top-1/2 right-4 w-10 h-10 rounded-full bg-white/15"></div>
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex items-center gap-2 pt-3" style="border-top: 1px solid rgba(99,102,241,0.1);">
                            <a href="{{ route('admin.menus.edit', $menu) }}" class="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-indigo-500/10 text-indigo-400 text-sm font-semibold rounded-xl hover:bg-indigo-500/20 transition-all">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                Edit
                            </a>
                            <form action="{{ route('admin.menus.destroy', $menu) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus menu {{ $menu->name }}?')" class="flex-1">
                                @csrf
                                @method('DELETE')
