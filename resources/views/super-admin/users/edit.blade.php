        ...
        <div class="rounded-2xl p-6 sm:p-8" style="background: rgba(30,27,75,0.5); border: 1px solid rgba(99,102,241,0.12);">
            <form action="{{ route('super-admin.users.update', $user) }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="number" name="balance" value="{{ old('balance', $user->balance) }}" min="0"
                        class="w-full px-4 py-3 rounded-xl text-white placeholder-slate-500 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition"
                        style="background: rgba(255,255,255,0.05); border: 1px solid rgba(99,102,241,0.2);">
                ...
                <!-- Password -->
                <div>
                    <label class="block text-sm font-semibold text-slate-300 mb-2">Password Baru <span class="text-slate-500 font-normal">(kosongkan jika tidak diubah)</span></label>
                ...
                <!-- Konfirmasi Password -->
                <div>
                    <label class="block text-sm font-semibold text-slate-300 mb-2">Konfirmasi Password Baru</label>
                ...
                <!-- Info -->
                <div class="rounded-xl p-4 text-xs text-slate-500 space-y-1" style="background: rgba(255,255,255,0.02); border: 1px solid rgba(99,102,241,0.08);">
