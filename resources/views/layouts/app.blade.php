            ...
            <!-- Profile Section -->
                ...
                <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
                    @if(Auth::user()->isSuperAdmin())
                        ...
                        <a href="{{ route('super-admin.users.index') }}" class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-slate-400 {{ request()->routeIs('super-admin.users.*') ? 'active' : '' }}">
